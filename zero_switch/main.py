...
class BluetoothDevice():
    ...
    PROFILE_DBUS_PATH = "/bluez/jasonaa/hidbluetooth_profile"  # dbus path of  the bluez profile we will create
...
class BluetoothService(dbus.service.Object):
    def __init__(self):
        ...
        bus_name = dbus.service.BusName("org.jasonaa.HidBluetoothService", bus=dbus.SystemBus())
        dbus.service.Object.__init__(self, bus_name, "/org/jasonaa/HidBluetoothService")
    ...
    @dbus.service.method('org.jasonaa.HidBluetoothService', in_signature='yay')
    ...
    @dbus.service.method('org.jasonaa.HidBluetoothService', in_signature='iai')
    ...
    def Introspect(self):
        return ET.tostring(ET.parse(os.getcwd() + '/org.jasonaa.hidbluetooth.introspection').getroot(), encoding='utf8',
                           method='xml')
...
class PageTwo(Frame):
    def __init__(self, master, background="white"):
        ...
        self.bluetoothservice = self.bus.get_object('org.jasonaa.HidBluetoothService', "/org/jasonaa/HidBluetoothService")
        self.iface = dbus.Interface(self.bluetoothservice, 'org.jasonaa.HidBluetoothService')
